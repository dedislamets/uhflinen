...
class RusakActivity : AppCompatActivity(), View.OnClickListener {

    private lateinit var mFm: FragmentManager
    private lateinit var mFt: FragmentTransaction
    private lateinit var fragment6: Fragment_Rusak
    ...
    override fun onBackPressed() {
        startActivity(Intent(this, ListRusakActivityRecycle::class.java))
        this.finish()
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem):Boolean {
        ...
        if (id == R.id.action_about)
        {
            ...
            startActivity(
                Intent(
                    applicationContext,
                    ListRusakActivityRecycle::class.java
                )
            )
        }
