...
class CariListRequestActivity : AppCompatActivity() , View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cari_list_request)
...
//            updateLabel()
    ...
    private  fun syncData(startFlag : Boolean = false){
