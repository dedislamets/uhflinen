...
import id.coba.kotlinpintar.Adapter.RusakAdapterKt
...
class ListRusakActivityRecycle : AppCompatActivity() , SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    private lateinit var rusakadapter: RusakAdapterKt
    var apiInterface: ApiInterface? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_list_rusak_recycleview)
        ...
        list.addOnScrollListener(object : RecyclerView.OnScrollListener(){
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                val total  = rusakadapter.itemCount
    ...
    private fun getUsers(isOnRefresh: Boolean, txtSearch: String = "") {
        ...
        Handler().postDelayed({
            ...
            apiInterface?.getLinenRusak(parameters)?.enqueue(object : Callback<RusakListResponse> {
                override fun onFailure(call: Call<RusakListResponse>, t: Throwable) {
                    Toast.makeText(this@ListRusakActivityRecycle, "${t.message}", Toast.LENGTH_SHORT).show()
                ...
                override fun onResponse(
                    call: Call<RusakListResponse>?,
                    response: retrofit2.Response<RusakListResponse>?
                ) {
                    ...
                    if (listResponse != null){
                        ...
                        if(listResponse.isEmpty()){
                            ...
                            rusakadapter.addList(listResponse)
                        }
    ...
    private fun setupRecyclerView() {
        ...
        rusakadapter = RusakAdapterKt()
        rvKeluar.adapter = rusakadapter

        rusakadapter.onItemClick = { contact ->
